...
public class MazeSolverFrame extends javax.swing.JFrame {
    ...
    public MazeSolverFrame() {
        ...
        final SpinnerModel model = new SpinnerNumberModel(Maze.DEFAULT_SIZE, Maze.MIN_SIZE, Maze.MAX_SIZE, 1);
     ...
     *
     * @param mazeSize int value in the range
     *                 {@link ie.homelab.mazesolver.model.Maze#MIN_SIZE} - {@link
     *                 ie.homelab.mazesolver.model.Maze#MAX_SIZE}
     */
    ...
    public static void main(final String[] args) {
        ...
        if (args.length > 0) {
            // validate args input
            int tempSize = Maze.DEFAULT_SIZE;
            boolean invalidSize = validateMazeSize(args[0]);
            if (invalidSize) {
                // Just run with the default value
                EventQueue.invokeLater(() -> new MazeSolverFrame(Maze.DEFAULT_SIZE).setVisible(true));
            } else {
    ...
    private String loadLicenseText() {
        ...
        try {
            ...
            System.getLogger(MazeSolverFrame.class.getName()).log(System.Logger.Level.ERROR, ex.getMessage(), ex);
        }
        return output;
    }
